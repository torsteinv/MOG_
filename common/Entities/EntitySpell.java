...
public abstract class EntitySpell extends Entity {
	...
	public EntitySpell(World par1World, double par2, double par4, double par6,
		...
		double var14 = MathHelper.sqrt_double(par8 * par8 + par10 * par10
				+ par12 * par12);
	...
	public EntitySpell(World par1World, EntityLiving par2EntityLiving,
		...
		double var9 = MathHelper.sqrt_double(par3 * par3 + par5 * par5 + par7
				* par7);
	...
	public void onUpdate() {
		if (!this.worldObj.isRemote
			...
			if (this.inGround) {
				int var1 = this.worldObj.getBlockId(this.xTile, this.yTile,
						this.zTile);
			...
			Vec3 var15 = this.worldObj.getWorldVec3Pool().getVecFromPool(
					this.posX, this.posY, this.posZ);
			Vec3 var2 = this.worldObj.getWorldVec3Pool().getVecFromPool(
					this.posX + this.motionX, this.posY + this.motionY,
					this.posZ + this.motionZ);
			MovingObjectPosition var3 = this.worldObj.rayTraceBlocks(var15,
					var2);
			var15 = this.worldObj.getWorldVec3Pool().getVecFromPool(this.posX,
					this.posY, this.posZ);
			...
			for (this.rotationPitch = (float) (Math.atan2(var16, this.motionY) * 180.0D / Math.PI) - 90.0F; this.rotationPitch
			...
			if (this.isInWater()) {
				for (int var19 = 0; var19 < 4; ++var19) {
					...
					this.worldObj.spawnParticle("bubble", this.posX
							- this.motionX * var18, this.posY - this.motionY
							* var18, this.posZ - this.motionZ * var18,
